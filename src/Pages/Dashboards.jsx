...
import { AlignJustify, ChevronRight, ChevronsUpDown, Clock, Columns4, Eclipse, Home, X, Search } from 'lucide-react'

const navigation = [
  { name: 'Home', href: '#', icon: Home, current: true },
  { name: 'My tasks', href: '#', icon: Columns4, current: false },
          ...
          <main className="flex-1">
            ...
            <div className="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
              ...
              <div className="mt-4 flex sm:mt-0 sm:ml-4">
                <button
                  type="button"
                  className="order-1 ml-3 inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-gray-50 sm:order-0 sm:ml-0"
                >
                  Share
                </button>
                <button
                    ...
                    <div className="flex flex-1 items-center justify-between truncate rounded-r-md border-t border-r border-b border-gray-200 bg-white">
                      ...
                      <Menu as="div" className="shrink-0 pr-2">
                        <MenuButton className="inline-flex size-8 items-center justify-center rounded-full bg-white text-gray-400 hover:text-gray-500 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-hidden">
                          ...
                          <Eclipse aria-hidden="true" className="size-5" />
                        </MenuButton>
                        <MenuItems
                          transition
