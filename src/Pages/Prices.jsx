  ...
  return (
    <div className="bg-white py-24 sm:py-32">
      ...
      <div className="relative pt-16 sm:pt-24">
        <div className="absolute inset-x-0 top-48 bottom-0 bg-[radial-gradient(circle_at_center_center,#00CED1,#20B2AA,#030712_70%)] lg:bg-[radial-gradient(circle_at_center_150%,#00CED1,#20B2AA,#030712_70%)]" />
                      ...
                      {typeof feature.tiers[tier.name] === 'string' ? (
                        ...
                        <>
                          {feature.tiers[tier.name] === true ? (
                            <Check aria-hidden="true" className="inline-block size-4 " />
                          ) : (
                            <Minus aria-hidden="true" className="inline-block size-4 fill-gray-400" />
                          )}
