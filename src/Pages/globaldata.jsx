...
import { ArrowBigDown, ArrowBigDownDash, ArrowBigLeftDash, EllipsisIcon, PlusCircle } from 'lucide-react';
...
export default function GlobalData() {
    ...
    const secondaryNavigation = [
        { name: t('globaldata.aText1'), href: '#', current: true },
        { name: t('globaldata.aText2'), href: '#', current: false },
        { name: t('globaldata.aText3'), href: '#', current: false },
    ]
    const stats = [
            ...
            <div className="relative isolate overflow-hidden pt-24">
                ...
                <header className="pt-6 pb-4 sm:pb-6">
                    <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
                        <h1 className="text-base/7 font-semibold text-gray-900">{t('globaldata.h1Text1')}</h1>
                        ...
                        >
                            <PlusCircle aria-hidden="true" className="-ml-1.5 size-5" />
                            New invoice
                        </a>
                    </div>
                </header>
